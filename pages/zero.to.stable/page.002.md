...
Your first move in Phase 2 should be to secure any government assistance that can provide a financial cushion or a direct path to income. These are <u>not long-term solutions</u>, but they are critical stepping stones.
...
- **Application Process**:
  1. Go to your Barangay Hall and secure a **Barangay Certification** or Proof of Residency. This document is <u>non-negotiable</u>.
  2. Prepare a resume (even if it's sparse) and a valid government-issued ID (Barangay ID, Voter's ID, or Postal ID).
  3. Visit your local Public Employment Service Office (PESO) and submit these documents. They will provide you with the DOLE Beneficiary Form.
  4. Wait for a call from PESO. Do not expect immediate deployment; follow up respectfully but persistently every few days.
...
This is the most direct path to stable, predictable income. You will likely earn minimum wage, and you will feel exploited. <u>Accept this</u>. This job is not your life; it is a temporary station to refuel.
...
- **Application Strategy**:
  1. Walk into malls, fast food chains, and retail stores with a printed resume.
